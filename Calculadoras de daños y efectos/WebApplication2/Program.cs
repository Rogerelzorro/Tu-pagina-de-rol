class Program
{
    static void Main()
    {
        ...
        if (Resultado > 0)
        {
            ...
            Console.WriteLine ("Introduzca el TA del defensor (Recuerda diferenciar fisico, calor, frio y energia)");
        ...
        Console.Write("¿Quieres reiniciar el programa? Escriba S, en caso de que asi sea. Escriba N, en caos de que no sea asi");
